...
class ListMovieGrillAdapter: NSObject, listMoviesAdapterProtocol {
...
extension ListMovieGrillAdapter: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let message = item as? String {
            ...
            return  MovieCollectionViewCell.buildIn(collectionView, in: indexPath, with: movie)
        }else {
...
extension ListMovieGrillAdapter: UICollectionViewDelegate {
